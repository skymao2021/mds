...
import UploadWordDialog from '@/components/CodemirrorEditor/UploadWordDialog.vue'
...
// 处理Word文件上传
function uploadWord(file: File) {
  importWordContent(file)
}
...
<template>
  <div ref="container" class="container flex flex-col">
    ...
    <main class="container-main flex flex-1 flex-col">
      ...
      <UploadWordDialog @upload-word="uploadWord" />
